...
public class GameScreen1 implements Screen {
 ...
 /*   public void game_level(){
    ...
    public void createTextButtons() {   // налаштування кнопок
        ...
        btn_1 = drawButton("btn1_press", 1);
        btn_2 = drawButton("btn2_press", 2);
        btn_3 = drawButton("btn3_press", 3);
        btn_4 = drawButton("btn4_press", 4);
        btn_5 = drawButton("btn5_press", 5);
        btn_6 = drawButton("btn6_press", 6);
